...
document.addEventListener('DOMContentLoaded', function () {
    // Attach an event listener to the "Salvar" button
    document.getElementById('salvarBtn').addEventListener('click', function () {
        // Show the msg_feedback div
        document.querySelector('.msg_feedback').style.display = 'block';

        // Submit the form
        document.getElementById('formAluno').submit();
    });

    // Attach an event listener to the OK button to hide the msg_feedback div
    document.getElementById('flash_button').addEventListener('click', function () {
        // Hide the msg_feedback div
        document.querySelector('.msg_feedback').style.display = 'none';
    });
});
